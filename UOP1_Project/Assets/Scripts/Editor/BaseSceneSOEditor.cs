...
[CustomEditor(typeof(BaseSceneSO), true)]
public class BaseSceneSOEditor : Editor
{
	...
	private BaseSceneSO _gameSceneInspected;
	
	private void OnEnable()
	{
		_gameSceneInspected = target as BaseSceneSO;
		PopulateScenePicker();
		InitializeGuiStyles();
	}
	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.ObjectField("Script", MonoScript.FromScriptableObject((BaseSceneSO)target), typeof(BaseSceneSO), false);
		//Make GUI editable.
		GUI.enabled = true;
