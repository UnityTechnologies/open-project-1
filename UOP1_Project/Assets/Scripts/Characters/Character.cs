...
public class Character : MonoBehaviour
{
	...
	[Tooltip("Represents how fast gravityContributionMultiplier will go back to 1f. The higher, the faster")] [SerializeField] private float _gravityComebackMultiplier = 15f;
	...
	private void Update()
	{
		...
		{
			_gravityContributionMultiplier += Time.deltaTime * _gravityComebackMultiplier;
		}
